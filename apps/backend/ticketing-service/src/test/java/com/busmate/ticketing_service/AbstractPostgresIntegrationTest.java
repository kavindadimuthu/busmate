 ...
 * Flyway baseline migration (Tier 1 schema) against a real Postgres, removing the old dependency on
 * a hand-configured local Postgres (see docs/plans/Database-Migrations-and-Seed-Data-Plan.md,
 * Phase 4).
 *
