...
export default function EditStaffPage() {
    ...
    useSetPageMetadata({
        ...
        breadcrumbs: [{ label: 'Staff Management', href: '/mot/staff' }, { label: 'Edit' }],
    });

    useSetPageActions(
        <button
            onClick={() => router.push(`/mot/staff/${staffId}`)}
    ...
    const handleSuccess = (staff: StaffMember) => {
        ...
        router.push(`/mot/staff/${staff.id}`);
    };

    const handleCancel = () => {
        router.push(`/mot/staff/${staffId}`);
    };
