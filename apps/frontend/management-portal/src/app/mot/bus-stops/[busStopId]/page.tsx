            ...
            <div className="flex-1">
              ...
              <div className="flex gap-3 mt-4">
                <button
                  ...
                  className="px-4 py-2 bg-destructive text-white rounded-lg hover:bg-destructive transition-colors"
                >
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {busStop.location?.citySinhala ? (
                      ...
                      <div className="text-muted-foreground italic text-sm">No city available</div>
                    )}
                    ...
                    {busStop.location?.stateSinhala ? (
                      ...
                      <div className="text-muted-foreground italic text-sm">No state available</div>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {busStop.location?.countrySinhala ? (
                      ...
                      <div className="text-muted-foreground italic text-sm">No country available</div>
                    )}
                  </div>
                </div>
              )}
