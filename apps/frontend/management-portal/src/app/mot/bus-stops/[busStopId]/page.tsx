...
import BusStopSystemInfo from '@/components/mot/bus-stops/BusStopSystemInfo';
          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-3 mt-4">
                ...
                <button onClick={() => router.push('/mot/bus-stops')} className="px-4 py-2 border border-destructive/30 text-destructive rounded-lg hover:bg-destructive/10 transition-colors">
