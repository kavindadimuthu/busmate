...
import { Plus, KeyRound, Ban, CheckCircle2, Link2, Link2Off } from 'lucide-react';
import {
  Button,
  Input,
  Label,
...
// Registry admin for the IoT device fleet (IoT Platform Layer plan, Phase 1). Devices don't emit
// telemetry yet (that's Phase 2) — this screen only covers provisioning, credentials, and bus
// assignment. The live map at /mot/tracking is a separate, later phase (Phase 3) that will
// eventually read from this same fleet.
