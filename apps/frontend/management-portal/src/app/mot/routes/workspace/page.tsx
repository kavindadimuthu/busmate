...
import { Toaster, Button, Badge, Progress, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@busmate/ui';
        ...
        return (
            <div className="flex items-center justify-center h-96">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-muted-foreground text-sm">Loading route group data...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="flex items-center justify-center h-96">
                <div className="flex flex-col items-center gap-4 text-center max-w-md">
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-foreground">Failed to load route group</h3>
            ...
            <RouteWorkspaceProvider>
                <Suspense fallback={
                    <div className="flex flex-col h-96 justify-center items-center gap-4">
                        <Loader2 className="h-8 w-8 animate-spin text-primary" />
                        <p className="text-muted-foreground text-sm">Loading routes workspace...</p>
                    </div>
                }>
