...
import { fareAmendmentsColumns } from './FaresAmendmentsColumns';

interface FaresAmendmentsTableProps
  extends Pick<
    DataTableProps<any>,
    | 'page'
    | 'pageSize'
...
export function FaresAmendmentsTable({
  data,
  totalItems,
  page,
  pageSize,
