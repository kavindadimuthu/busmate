...
// Ported from management-portal app/operator/fleet/page.tsx — body unchanged
// except the Next.js page-metadata plumbing now comes from the ported PageContext
// and there's no Next `'use client'` directive.
