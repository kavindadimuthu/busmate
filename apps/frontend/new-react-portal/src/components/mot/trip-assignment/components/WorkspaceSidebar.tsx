  ...
  return (
    <div className="w-80 bg-card border-r border-border flex flex-col">
      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        <div className="p-4 border-b border-border">
          <h3 className="text-sm font-semibold text-foreground mb-3">Route Selection</h3>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {workspace.isLoadingRouteGroups ? (
            ...
            <div className="text-center py-8">
              ...
              <div className="text-sm text-muted-foreground">{workspace.routeGroupsError}</div>
            </div>
          ) : (
            <div className="space-y-2">
              {filteredRouteGroups.map(routeGroup => (
                <div key={routeGroup.id} className="border border-border rounded-lg overflow-hidden">
                  {/* Route Group Header */}
                  <div
                  ...
                  {expandedRouteGroups.includes(routeGroup.id || '') && routeGroup.routes && (
                    <div className="bg-card">
                      {routeGroup.routes.map(route => (
                        <div
                          key={route.id}
                          className={`p-3 cursor-pointer border-t border-border/50 transition-colors ${
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            <Route className="h-4 w-4 text-muted-foreground/70" />
