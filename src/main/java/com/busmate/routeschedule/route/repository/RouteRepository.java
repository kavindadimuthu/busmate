...
public interface RouteRepository extends JpaRepository<Route, UUID> {
    ...
    Page<Route> findAllWithFilters(
            ...
            @Param("roadType") com.busmate.routeschedule.route.enums.RoadTypeEnum roadType,
    ...
    List<com.busmate.routeschedule.route.enums.RoadTypeEnum> findDistinctRoadTypes();
